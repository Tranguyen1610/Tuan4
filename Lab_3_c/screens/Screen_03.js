    ...
    return (
      <View style={styles.container}>
        <View style={styles.detail_con}>
            <Image style={styles.img} source={require('../assets/vs_red_a 2.png')}/>
            <View>
            <Text style={{fontSize:18,width:250}}>Điện Thoại Vsmart Joy 3 Hàng chính hãng</Text>
            <Text style={{fontSize:18,width:250}}>Màu: đỏ</Text>
            <Text style={{fontSize:18,width:250}}>Cung cấp bởi Tiki Tradding</Text>
            <Text style={{fontSize:18,width:250,fontWeight:'bold'}}>1.790.000 đ</Text>
            </View>
        </View>
